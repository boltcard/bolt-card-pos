	...
	return (
        ...
        >
          <View style={{justifyContent: 'center', flex: 1, backgroundColor: "#FF9900"}}>
            ...
            <View style={{flexDirection: 'row', justifyContent: 'center', marginBottom: 30, height: 20}}>
    				{pinCode.split("").map(num => (
    					<CircleBorder fill={true} containerStyle={{marginRight: 10}}/>
    				))}
            </View>
            ...
            <View style={{flexDirection: 'row', marginBottom: 10}}>
              <PinCodeButton number={<Icon name="check" size={35}/>} onPress={() => {
                setPinCode("");
                props.onEnter();
              }} />
